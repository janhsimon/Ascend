...
public:
  Game()
  {
    ...
    const auto createSurfaceLambda = [&](const VkInstance* instance) -> VkSurfaceKHR*
    {
    ...
    auto applicationInfo = asc::ApplicationInfo().setName(APP_NAME).setVersion(1, 0, 0).setInstanceExtensions(queryInstanceExtensions()).setCreateSurfaceLambda(createSurfaceLambda);
